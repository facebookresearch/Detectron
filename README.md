...
This update to the original Detectron code aims to communicate object detection information over a ROS node, aiding in computer vision projects in the field of Robotics. See [`INSTALL.md`](INSTALL.md) for installation instructions for Caffe2, Detectron and ROS. Note that this project has been tested on ROS Kinetic with python 2
